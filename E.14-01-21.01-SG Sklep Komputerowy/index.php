...
<body>
    ...
    <div id="glowny">
        ...
        <table border="1">
            ...
            $zapytanie = mysqli_query($polonczenie,'SELECT nazwa , opis , cena from podzespoly WHERE dostepnosc = 1 ');
    ...
    <div id="stopka1">
        ...
        <p>Współpracujemy z hurtownią <a href=" 
http://www.ddata.pl/" target="_blanc">ddata</a></p>
    </div>
    <div id="stopka2">

...
<body>
    ...
    <div id="glownyL">
        ...
        <?php
            ...
            $zapytanie = mysqli_query($polonczenie,'select id, Gromady_id, gatunek, wystepowanie from zwierzeta where Gromady_id = 4');
    ...
    <div id="glownyP">
        ...
        <ol>
            ...
            <?php
                $polonczenie = mysqli_connect('localhost','root','','egzamin5');
                $zapytanie = mysqli_query($polonczenie,'SELECT gatunek , obraz from zwierzeta where gromady_id = 4');
                while ($r = mysqli_fetch_array($zapytanie))
                {
